...
{
    internal class SubOperationByWorkOrderNotify : INotifyTable
    {
        private INotifyWcf<SubOperationByWorkOrder> NofigycationTable { get; set; }

        public SubOperationByWorkOrderNotify()
        {
            NofigycationTable = new NotifyWcf<SubOperationByWorkOrder>();
        }
