...
namespace TestSystimeCore
{
    ...
    public class EncryptedConfig
    {
        ...
        public void EncryptedFileConfig()
        {
            ...
            String conectionSystime = @"metadata=res://*/DataAccess.SystimeDb.csdl|res://*/DataAccess.SystimeDb.ssdl|res://*/DataAccess.SystimeDb.msl;provider=System.Data.SqlClient;provider connection string='data source=192.168.99.1,49192;initial catalog=Systimedb;user id=sa;password=J1u5a0n6fxe;MultipleActiveResultSets=True;'";
            ...
            String conectionSystimeTest = @"metadata=res://*/DataAccess.SystimeDb.csdl|res://*/DataAccess.SystimeDb.ssdl|res://*/DataAccess.SystimeDb.msl;provider=System.Data.SqlClient;provider connection string='data source=192.168.99.1,49192;initial catalog=Systimedb;user id=sa;password=J1u5a0n6fxe;MultipleActiveResultSets=True;'";
            String conectionNotification = @"metadata=res://*/DataAcces.NotificationDb.csdl|res://*/DataAcces.NotificationDb.ssdl|res://*/DataAcces.NotificationDb.msl;provider=System.Data.SqlClient;provider connection string='data source=192.168.99.1,49192;initial catalog=Systimedb;persist security info=True;user id=sa;password=J1u5a0n6fxe;MultipleActiveResultSets=True;'";
