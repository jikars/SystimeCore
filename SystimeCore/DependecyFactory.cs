...
namespace SystimeCore
{
    internal static class DependencyFactory
    {
        ...
        private static void PrechargeDependency()
        {
            ...
            RegisterDependency<IWcfSystime, WcfSystime>();
            RegisterDependency<INotificationSql, NotificationSql>();
            RegisterDependency<ISchemaTables, SchemaTables>();
            RegisterDependency<INotifyManager, NotificationManager>();
        }
